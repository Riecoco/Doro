<template>
  ...
  >
    <h2 class="text-md sm:text-lg md:text-xl lg:text-xl font-bold mb-5 text-white">Settings</h2>
    <section v-if="!authStore.user" class="flex-col space-y-1 text-sm md:text-md ">
      <h4 class="text-md md:text-lg lg:text-lg">Account</h4>
      <RouterLink
        to="/login"
    ...
    <section v-else class="flex-col space-y-1 text-sm md:text-md lg:text-md">
    ...
    <section class="flex flex-col space-y-1">
      <h4 class="text-md md:text-lg lg:text-lg">General</h4>
      <div class="flex items-center justify-between gap-3 text-sm md:text-md lg:text-md">
    ...
    <section class="flex flex-col space-y-1">
      <h4 class="text-md md:text-lg lg:text-lg">Timer Settings (in mins)</h4>
      <div class="flex lg:flex-row flex-col lg:space-x-6 space-y-4 text-sm md:text-md lg:text-md">
